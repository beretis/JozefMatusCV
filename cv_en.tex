...
\begin{outerlist}
  ...
  \begin{innerlist}
    \item[] My responsibility was to build new Mobile team (iOS, Android), create tech stack and CI pipelanes and guide developers.
  \end{innerlist}
...
\begin{description}
  ...
  \item[Web]\blankline
  \begin{innerlist}
    \item[Basic] AJAX, JavaScript, CSS, HTML, XHTML
  \end{innerlist}
