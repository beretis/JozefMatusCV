...
\begin{outerlist}
  \item[] \textit{Lead IOS}%
          \hfill \textbf{since August 2016 to Present}
  \begin{innerlist}
    \item[] Working on a new product which is still classified (will be presented 8.6.2017), leading IOS team (2 members), designing and implementing architecture.
  \end{innerlist}
