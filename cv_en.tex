...
Prague & \textit{Mobile:} +421911912352 \\
...
\begin{outerlist}
  \item[] \textit{Mobile Lead}%
          \hfill \textbf{since September 2017 to Present}
  \begin{innerlist}
    \item[] My responsibility was to build new Mobile team (iOS, Android), create tech stack and CI pipelanes and couch developers.
  \end{innerlist}
...
\begin{outerlist}
  \item[] \textit{Lead IOS}%
          \hfill \textbf{since August 2016 to Present to August 2017}
  \begin{innerlist}
    \item[] Lleading IOS team (3 members), designing and implementing architecture of a new product called O2 Smart Box - https://www.o2.cz/osobni/smart-box/
  \end{innerlist}
