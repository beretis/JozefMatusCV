...
\begin{outerlist}
  \item[] \textit{iOS developer}%
          \hfill \textbf{since September 2019 to Present}
  \begin{innerlist}
    \item[] Dealing with technical debt, test coverage and refactoring on various client's apps. 
  \end{innerlist}
...
\begin{outerlist}
  ...
  \begin{innerlist}
    \item[] My responsibility was to build new Mobile team (iOS, Android), create tech stack, CI pipelines and guide developers.
  \end{innerlist}
...
\begin{description}
  ...
  \begin{innerlist}
    \item[Advanced]  Swift ,Java, Objective-C, SQL, Kotlin
    \item[Basic] C++, Python, Bash, JavaScript
  \end{innerlist}
  
  \item[Databases]\blankline
  \begin{innerlist}
    \item[Advanced] MySQL,PostgreSQL, SQLite
    \item[Basic] 
  \end{innerlist}
...
\section{Hobbies}
%
Swift programming, open source, movies, TV shows, football, bike, running, fitness. 
